...
export default function ActionComponent({
  ...
  return (
    <div className="rounded-2xl">
      <Alert className="flex flex-col px-6 py-8 gap-4 bg-gradient-to-br from-primary/20 to-secondary/20 rounded-2xl border-none">
        ...
        <AlertDescription>
          <p className="text-zinc-200">
            ...
            required, it could take up to a few minutes for your rumour to be posted.<br /><br />
        ...
        <div className="flex flex-row gap-2 justify-between ">
          <div className="flex flex-row gap-4">
            ...
            <a
              ...
              className="text-sm bg-secondary px-3 py-2 rounded-full font-medium"
            >
