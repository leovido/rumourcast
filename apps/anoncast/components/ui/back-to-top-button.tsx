...
const BackToTopButton = () => {
  ...
  return (
    <button
      onClick={scrollToTop}
      className="gradient-border-wrapper fixed bottom-6 right-6 z-50 w-14 h-14 flex items-center justify-center bg-primary text-white rounded-full shadow-xl transition-transform duration-300 hover:scale-105"
